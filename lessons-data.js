...
const lessonsData = [
  ...
  {
    id: "lesson-photosynthesis-part2",
    order: 2,
    unit: 3,
    status: "published",
    icon: "🌿⚗️☀️",
    title: "Photosynthesis Part 2 · الجزء الثاني",
    desc: "الدرس الثاني لوحدة تدفق الطاقة (الوحدة الثالثة): ميكانيزم البناء الضوئي والعوامل المؤثرة فيه (صفحات 240–247) — كيف يمتص الكلوروفيل الضوء الأزرق والأحمر وينقسم الماء ويتكوّن الجلوكوز في مرحلتين، وموازنة المعادلة، وتجربة اليود لإثبات أهمية الكلوروفيل والضوء، والتحكم في معدل البناء الضوئي بدرجة الحرارة وثاني أكسيد الكربون والضوء.",
    cta: "ابدأ الدرس ←",
    href: "lesson-photosynthesis-part2.html",
    lang: "ar"
  }
];
